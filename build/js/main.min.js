...
var _phoneMask = require("./utils/phone-mask/phone-mask");
...
},{"./modules/audio":2,"./modules/form-validate/form":5,"./modules/map":11,"./modules/menu-open":12,"./modules/swiper":13,"./modules/video":14,"./utils/ios-vh-fix":17,"./utils/phone-mask/phone-mask":18}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.audioLoad = void 0;
var audio = document.querySelector('.audio__player');
var link = document.querySelector('.audio__button');
var audioLoad = function audioLoad() {
  if (link && audio) {
...
},{"../utils/focus-lock":15,"../utils/scroll-lock":19}],4:[function(require,module,exports){
"use strict";
...
var initSwiper = function initSwiper() {
  ...
  var promoImage = new Swiper('.promo__swiper-image', {
  ...
  // eslint-disable-next-line
  var promoContent = new Swiper('.promo__swiper-content', {
    pagination: {
  ...
  // eslint-disable-next-line
  var swiperTours = new Swiper('.tours__swiper', {
    navigation: {
  ...
  // eslint-disable-next-line
  var swiperTraining = new Swiper('.training__swiper', {
    navigation: {
  ...
  if (document.documentElement.clientWidth > 1199) {
    // eslint-disable-next-line
    var swiperAdv = new Swiper('.adv__swiper', {
      navigation: {
...
exports.videoLoad = void 0;
var video = document.querySelector('.video__player');
var link = document.querySelector('.video__button');
